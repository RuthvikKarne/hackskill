...
from app.core.events.bus import init_event_bus
...
from app.core.security.middleware import JWTAuthMiddleware, SecurityHeadersMiddleware, RequestSizeLimitMiddleware
...
def create_app() -> FastAPI:
    ...
    # ── Middleware (executed in reverse order: RequestID → JWT → CORS → Router) ─
    app.add_middleware(
        CORSMiddleware,
